...
function wptcajaxsend(){
	...
	c.innerHTML = "<div id=\"newcommentcontent\"><p>"+author+" <em>Submit on "+dateObj.toLocaleString()+"</em>:</p>"+comment+"</div><div id=\"newcommentsubmit\"><p>new comment is submiting, please wait a comment...<img src=\"http://www.21andy.com/blog/wp-content/plugins/wordpress-thread-comment/loading.gif\" /></p></div>";
