...
_st_dest="http://"+_st_ip+_st_dest+"&uv="+_st_uv+"&nuv="+_st_nuv+"&ss="+_st_ss+"&usn="+_st_url_sn+"&ec="+_en_co+"&ref="+_st_ref+"&url="+_st_url+"&nac="+_st_sof+"&agt="+_st_agt+"&clr="+_st_clr+"&scr="+_st_scr+"&lng="+_st_lng+"&jvm="+_st_jvm+"&flu="+_st_flu+"&tm=1325483448"+"&tc=d1204b0052640c7d86a4f7ad5984acbd"+"&ut=0"+"&cnu="+_st_cva+"&jjj=3";
